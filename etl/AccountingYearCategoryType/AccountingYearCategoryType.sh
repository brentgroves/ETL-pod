...
TIMEFORMAT='%R'; time ./AccountingYearCategoryType.py '123681,300758' "$username" "$password" "$username2" "$password2" 1>&4 2>&3
result=$?
if [[ $result -eq 0 ]]
then # if/then branch
  ../misc/script-end.py 3 0
else
  ../misc/script-end.py 3 1
fi
} 2>&6 
